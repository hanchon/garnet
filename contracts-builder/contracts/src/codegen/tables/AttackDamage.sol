...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AttackDamage")));
bytes32 constant AttackDamageTableId = _tableId;

library AttackDamage {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("AttackDamage", _fieldNames);
  }
