...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("MovementSpeed")));
bytes32 constant MovementSpeedTableId = _tableId;

library MovementSpeed {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("MovementSpeed", _fieldNames);
  }
