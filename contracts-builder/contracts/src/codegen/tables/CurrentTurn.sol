...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CurrentTurn")));
bytes32 constant CurrentTurnTableId = _tableId;
...
library CurrentTurn {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CurrentTurn", _fieldNames);
  }
