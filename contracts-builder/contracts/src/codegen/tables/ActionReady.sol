...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("ActionReady")));
bytes32 constant ActionReadyTableId = _tableId;
...
library ActionReady {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("ActionReady", _fieldNames);
  }
