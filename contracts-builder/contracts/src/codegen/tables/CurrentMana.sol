...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CurrentMana")));
bytes32 constant CurrentManaTableId = _tableId;
...
library CurrentMana {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CurrentMana", _fieldNames);
  }
