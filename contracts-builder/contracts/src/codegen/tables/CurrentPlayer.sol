...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("CurrentPlayer")));
bytes32 constant CurrentPlayerTableId = _tableId;

library CurrentPlayer {
  ...
  function getMetadata() internal pure returns (string memory, string[] memory) {
    ...
    _fieldNames[0] = "value";
    return ("CurrentPlayer", _fieldNames);
  }
